...
import styles from './VideoCreation.module.scss';
  ...
  async function handleRecording() {
    ...
    try {
      ...
      player.on('finishRecord', async () => {
        if (isSafari) {
          // const getSeekableBlob = (player.recordedData, function (blob) {
          var blobUrl = URL.createObjectURL(player.recordedData);
          console.log('blobUrl', blobUrl);
          Router.push({
            pathname: '/ch/replays/VideoReplay',
            query: { name: `${blobUrl}`, type: `mp4`, seconds: `0`, recording: 'video' },
          });
          // });
        } else {
          ...
          getSeekableBlob(player.recordedData, function (blob) {
            ...
            Router.push({
              ...
              pathname: '../../../../ch/replays/VideoReplay',
              query: { name: `${blobUrl}`, type: `mp4`, seconds: `${duration}`, recording: 'video' },
            });
          });
        }
          ...
          <div className="position-absolute px-0 h-100">
            ...
            >
              ...
              >
                ...
                <ArrowBackIcon style={{ color: '#FFFFFF' }} onClick={() => Router.push('/')} />
              ...
              >
                <div
                  ...
                  style={{
                    width: '97%',
                    height: '65px',
                    backgroundColor: 'rgba(48, 53, 72, 0.4)',
                ...
                >
                  <div className="position-absolute row col-6 col-md-4 d-flex align-items-center justify-content-start white">
                    ...
                    <span
                      ...
                      className="h5 mb-0 white text-capitalize px-0 text-md-start col-6 text-nowrap d-md-inline col-6 col-md-6 col-lg-8 col-xxl-9"
                    >
                      {text}
                    </span>
                  </div>

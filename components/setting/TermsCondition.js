      ...
      <div className={classes.whiteBox2}>
        <div className="col-md-12 d-flex">
          <div className="col-md-7 p-2">
            <h2 className="p-2">Terms & Conditions</h2>
            <p className="p-2">you can add terms & conditions here</p>
          </div>
          <div className="col-md-5 p-2 px-4">
            <div className="d-flex justify-content-end mt-3">
              <span className="regular-small pe-2">Add Document</span>
              <Image
        ...
        <div className="col-md-12 col-sm-12 col-12 mt-4">
          <div className="d-flex  align-items-center" style={{ flexDirection: 'column' }}>
            <Image src="/assets/icons/undraw_terms_re_6ak4 1.svg" width="100px" height="100px" />
